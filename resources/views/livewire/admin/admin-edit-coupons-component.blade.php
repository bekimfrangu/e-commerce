                        ...
                        @endif
                            <form class="form-horizontal" wire:submit.prevent="editCoupon()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="code" class="form-control input-md" wire:model="code"/>
                                         @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="value" class="form-control input-md" wire:model="value"/>
                                         @error('value')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="cart_value" class="form-control input-md" wire:model="cart_value"/>
                                         @error('cart_value')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
