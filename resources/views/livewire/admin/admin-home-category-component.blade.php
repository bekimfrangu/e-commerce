                        ...
                        @endif
                            <form class="form-horizontal" wire:submit.prevent="updateHomeCategory()">
                                <div class="form-group">
                                    <label for="categories" class="col-md-4 control-label">Choose Categories</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="slug" class="form-control input-md" wire:model="numberofproducts"/>
